...
<div class="text-white text-sm lg:text-xl font-bold bg-gray-700 p-4 lg:p-8 rounded-lg border-gray-600 border-2 w-full mt-4 flex space-x-8 text-center lg:text-left justify-between items-center">
